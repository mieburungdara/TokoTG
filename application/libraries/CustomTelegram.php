...
class CustomTelegram extends Telegram
{
    ...
    public function processUpdate(Update $update): ServerResponse
    {
        try {
            ...
            // Log any error from our custom logic but DON'T stop the script
            log_message('error', '[Custom Logger Error] ' . $e->getMessage());
        }

        // IMPORTANT: Continue with the original processing, no matter what.
        // This marks the update as "processed" and prevents the infinite loop.
