<!-- application/views/seller/edit_product.php -->
<style>
    :root {
...
<div class="form-container">
    <h2 style="text-align: center; margin-top: 0;">Edit Product</h2>
    <form id="edit-product-form">
        ...
        <div class="form-group">
            ...
            <input type="text" id="product_code" name="product_code" value="<?php echo htmlspecialchars($product['product_code']); ?>" required maxlength="5" pattern="[0-9]{5}" readonly>
        </div>
        <div class="form-group">
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        form.addEventListener('submit', function(e) {
            ...
            const formData = {
                ...
                // product_code is not sent as it should not be changed
                description: document.getElementById('description').value,
                price: parseFloat(document.getElementById('price').value),
                stock_quantity: parseInt(document.getElementById('stock_quantity').value)
            };

            fetch(`<?php echo site_url("api/update_product"); ?>/${productId}`, {
