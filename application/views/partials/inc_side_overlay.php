          ...
          <div class="block mb-0">
            ...
            <div class="block-content block-content-full">
              <div class="row g-sm text-center">
                ...
                <div class="col-4 mb-1">
                  <a class="d-block py-3 text-white fs-sm fw-semibold bg-xwork" data-toggle="theme" data-theme="<?php echo base_url($dm->assets_folder . '/css/themes/xwork.min.css'); ?>" href="#">
                    xWork
                  </a>
                </div>
                <div class="col-4 mb-1">
                  <a class="d-block py-3 text-white fs-sm fw-semibold bg-xmodern" data-toggle="theme" data-theme="<?php echo base_url($dm->assets_folder . '/css/themes/xmodern.min.css'); ?>" href="#">
                    xModern
                  </a>
                </div>
                <div class="col-4 mb-1">
                  <a class="d-block py-3 text-white fs-sm fw-semibold bg-xeco" data-toggle="theme" data-theme="<?php echo base_url($dm->assets_folder . '/css/themes/xeco.min.css'); ?>" href="#">
                    xEco
                  </a>
                </div>
                <div class="col-4 mb-1">
                  <a class="d-block py-3 text-white fs-sm fw-semibold bg-xsmooth" data-toggle="theme" data-theme="<?php echo base_url($dm->assets_folder . '/css/themes/xsmooth.min.css'); ?>" href="#">
                    xSmooth
                  </a>
                </div>
                <div class="col-4 mb-1">
                  <a class="d-block py-3 text-white fs-sm fw-semibold bg-xinspire" data-toggle="theme" data-theme="<?php echo base_url($dm->assets_folder . '/css/themes/xinspire.min.css'); ?>" href="#">
                    xInspire
                  </a>
                </div>
                <div class="col-4 mb-1">
                  <a class="d-block py-3 text-white fs-sm fw-semibold bg-xdream" data-toggle="theme" data-theme="<?php echo base_url($dm->assets_folder . '/css/themes/xdream.min.css'); ?>" href="#">
                    xDream
                  </a>
                </div>
                <div class="col-4 mb-1">
                  <a class="d-block py-3 text-white fs-sm fw-semibold bg-xpro" data-toggle="theme" data-theme="<?php echo base_url($dm->assets_folder . '/css/themes/xpro.min.css'); ?>" href="#">
                    xPro
                  </a>
                </div>
                <div class="col-4 mb-1">
                  <a class="d-block py-3 text-white fs-sm fw-semibold bg-xplay" data-toggle="theme" data-theme="<?php echo base_url($dm->assets_folder . '/css/themes/xplay.min.css'); ?>" href="#">
                    xPlay
                  </a>
                </div>
              </div>
